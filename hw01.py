...
def main():
    ...
    b = 7
    c = -1
    #I define my variable's values:
    
    #I set my result equal to the division equation
    result = ((3*x)-(9*y))/((2*a)*(b-c))

#I print the variable's values and the final result
    print("Part 1: x =", x)
    print("Part 1: y =", y)
    print("Part 1: a =", a)
    print("Part 1: b =", b)
    ...
    #I define the variable's values
    x = 5
    y = -3
    
    #I set my result2 equal to the equation
    result2 = (x**2)*(y**4)
    
    #I print my variable's values and the equation's results
    print("Part 2: x =", x)
    print("Part 2: y =", y)
    ...
    #I set my result equal to the equation (using // to get an int)
    result = 100 // 13
    
    #I print the variable's values and the result of the equation
    print("Part 3: a =", a)
    print("Part 3: b =", b)
    ...
    #I don't need to define new variables as I'm using the same from Part 3
    #I set my result equal to the equation (using % to get the remainder)
    result4 = 100 % 13
    
    #I print the equation's result
